    ...
    <div class="col-lg-12 pt-20">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <form role="form" action="{{route('storeSubChildCategory')}}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="col-lg-12">
                            
                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                <label>SubChild Category <span class="required-star">*</span></label>
                            ...
                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                ...
                                <select disabled name="sub_category_id" id="sub_category_id" class="form-control" required>
