function deactivateConsumer(consumer_id) {
    var result = window.confirm('Are you sure you want to deactivate this consumer?');
    if (result == false) {
...
function activateConsumer(consumer_id) {
    var result = window.confirm('Are you sure you want to activate this consumer?');
    if (result == false) {
        event.preventDefault();
    } else {
...
$('input[name="user_type"]').change(function () {
    ...
    if ($('input#user_type').val() == "1") {
        ...
        $("#professional-fields #company_address").prop('required', false);
        ...
        $("#professional-fields #company_address").prop('required', true);
    }
}); 
// $('input[name="user_type"]').change(function () {
//     if ($('input#user_type').val() == "1") {
