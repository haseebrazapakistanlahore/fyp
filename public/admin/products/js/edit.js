...
$("#product_type").on('change', function () {
    ...
    if ($(this).val() == 0) {
        ...
        if ($('input#price_consumer').length == 0) {
...
function getPriceHtml(productType) {
    ...
    if (productType == 0) {
        ...
        <input type="number" id="price_consumer" class="form-control" name="price_consumer" value="' + price + '" placeholder="Unit Price For Consumers" \
         required> </div>';
        ...
        return '<div class="form-group col-md-6 col-sm-6 col-xs-12">\
        <label>Consumer Price <span class="required-star">*</span></label>\
        <input type="number" id="price_consumer" class="form-control" name="price_consumer" value="' + consumerPrice + '" placeholder="Unit Price For Consumers" \
         required> </div>\
